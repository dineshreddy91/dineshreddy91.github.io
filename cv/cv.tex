...
\section{EDUCATION}
\begin{tabular}{rl}	
 \textsc{Jan 17 - Current}  & Master of science in robotics, \bf{CMU RI, USA}\\
...
\begin{tabular}{rl}	
 \textsc{Feb 17 - Current} &  Graduate Research Assistant,\bf{ILIM Lab, CMU, USA}\\
 ...
 \textsc{Mar 16 - Dec 16} &  Graduate Intern,\bf{ Max Planck institute, Germany}\\
...
&\small Advisor: \href{http://www.cvlibs.net/} {Prof. Andreas \textsc{Geiger}} \\&\\

 \textsc{Jan 14 - Mar 16} &  Graduate Research Assistant,\bf{RRC, IIIT hyderabad, INDIA}\\
 ...
 \textsc{jan 13 - Dec 13} &  Undergraduate Research Assistant,\bf{Biology lab, BITS-Pilani, INDIA}\\
...
Convolutions} {\sl International Conference on Computer Vision Theory and Applications (VISAPP), 2017.}\href{http://robotics.iiit.ac.in/people/nazrul.athar/SMS/} {[Project Page]}
...
Nazrul Athar, \textbf{N Dinesh Reddy}, K madhava krishna. \textbf{Dynamic video semantic segmentation using Spatio temporal
      optimization} {\sl International Conference on Robot Learning(CORL), 2017.(under review)}
%\newpage
...
$\bullet$  Developed the product for testing the antibiotic is resistant or sensitive for urinary tract infection.\href{http://www.deccanchronicle.com/140707/lifestyle-offbeat/article/two-innovations-hyderabad-are-giving-new-hopes-rural-india}{Link}\\
...
$\bullet$ Head of the technical team of the technical-cultural fest of BITS Hyderabad, Pearl 2012 \href{http://www.bits-pearl.org/}{Link}.\\
...
%\begin{itemize}
$\bullet$ Badminton team member at BITS and CMU.\\
